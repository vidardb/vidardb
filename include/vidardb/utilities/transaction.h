...
// See examples/transaction_example.cc for more information.
//
// To create a transaction, use TransactionDB::BeginTransaction().
//
...
class Transaction {
 public:
  ...
  // until Put/Delete/GetForUpdate is called.
  ...
  // Put and Delete behave similarly to the corresponding
  ...
  // GetForUpdate(), calling UndoGetForUpdate will tell
  // the transaction that it no longer needs to do any conflict checking
  // for this key.
  //
  // If a key has been fetched N times via GetForUpdate(),
